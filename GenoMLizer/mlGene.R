...
varNames_df <- setNames(varNames_df, c("variableNames"))
varNames_df$keyNames <- keyNames
write.csv(as.data.frame(varNames_df), "variableKeys_gene_ML_test_dt_rf.csv", row.names = FALSE)

file_out_train <- paste(args[3], "_train_results.csv", sep = "")
file_out_test <- paste(args[3], "_test_results.csv", sep = "")
file_dt_csv <- paste(args[3], "_dt_vi.csv", sep = "")
file_dt_plot <- paste(args[3], "_dt_vi.pdf", sep = "")
file_rf_csv <- paste(args[3], "_rf_vi.csv", sep = "")
file_rf_plot <- paste(args[3], "_rf_vi.pdf", sep = "")
file_lasso_csv <- paste(args[3], "_lasso_vi.csv", sep = "")
file_lasso_plot <- paste(args[3], "_lasso_vi.pdf", sep = "")
file_nb_csv <- paste(args[3], "_nb_vi.csv", sep = "")
file_nb_plot <- paste(args[3], "_nb_vi.pdf", sep = "")
file_svmLin_csv <- paste(args[3], "_svmLin_vi.csv", sep = "")
file_svmLin_plot <- paste(args[3], "_svmLin_vi.pdf", sep = "")
file_svmPoly_csv <- paste(args[3], "_svmPoly_vi.csv", sep = "")
file_svmPoly_plot <- paste(args[3], "_svmPoly_vi.pdf", sep = "")
file_svmRB_csv <- paste(args[3], "_svmRB_vi.csv", sep = "")
file_svmRB_plot <- paste(args[3], "_svmRB_vi.pdf", sep = "")
file_logReg_csv <- paste(args[3], "_logReg_vi.csv", sep = "")
file_logReg_plot <- paste(args[3], "_logReg_vi.pdf", sep = "")
file_xgbt_csv <- paste(args[3], "_xgbt_vi.csv", sep = "")
file_xgbt_plot <- paste(args[3], "_xgbt_vi.pdf", sep = "")
file_enet_csv <- paste(args[3], "_enet_vi.csv", sep = "")
file_enet_plot <- paste(args[3], "_enet_vi.pdf", sep = "")
...
cat(performance(obs_test, pred_test_prob))
